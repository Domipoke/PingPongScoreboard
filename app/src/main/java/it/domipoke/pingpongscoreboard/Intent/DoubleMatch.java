...
public class DoubleMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PL1 = (Player) ((List) g.get("players")).get(0);
        PL2 = (Player) ((List) g.get("players")).get(1);
        PL3 = (Player) ((List) g.get("players")).get(2);
        PL4 = (Player) ((List) g.get("players")).get(3);
    ...
    private void startSet() {
        ...
        pl1.setBackgroundColor(((Player) ((List) g.get("players")).get(0)).getColor());
        pl2.setBackgroundColor(((Player) ((List) g.get("players")).get(1)).getColor());
        updateScoreText();
        ...
        brempl2.setOnClickListener(view -> {if (((int) g.get("score1"))>0) g.updateScore(2, -1, this);updateScoreText();});
    }
    ...
    private void updateScoreText() {
        ...
        try {
            TextView upddouble = findViewById(R.id.updatessingle);
